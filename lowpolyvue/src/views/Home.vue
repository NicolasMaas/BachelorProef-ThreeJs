  ...
  <div class="home">
    ...
    <div class>
      ...
      >
        ...
        <VueColorpicker v-model="color" @change="onChange"></VueColorpicker>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    var pointLight = new THREE.PointLight(this.color, 1.5, 10000);
    ...
    pointLight2.position.set(-180, 600, -200);
